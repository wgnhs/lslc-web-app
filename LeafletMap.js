...
//             },
    ...
    function initPopups(map, layer){
        ...
        var content = "<h3>Samples in Section " + sectionResults[0].attributes.SectionId + "</h3>";

        //loops through samples in the section adding a line for each of them
        for (i in sectionResults) {
            var listedSectionId = sectionResults[i].attributes.SampleId;
            //creates a new p with a link to the smaples page
            content = content + "<p><a href='sampleRecord.html#" + listedSectionId + "'>" + listedSectionId + "</a></p>";
        }
